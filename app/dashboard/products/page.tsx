/**
 * Products Page
 * Dedicated page for managing products
 */
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All your products for AI recommendations</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Add products to your catalog to enable AI recommendations to customers
            </p>
          </div>
        </CardContent>
      </Card>
